...
import '../../../../msg/db/v1/enum.pbenum.dart' as $1;
...
class ListResponse extends $pb.GeneratedMessage {
  factory ListResponse({
    $core.Iterable<$2.Artifact>? elements,
    $core.int? totalSize,
  }) {
    final $result = create();
    if (elements != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'extremo.api.mypage.artifacts.v1'), createEmptyInstance: create)
    ..pc<$2.Artifact>(1, _omitFieldNames ? '' : 'elements', $pb.PbFieldType.PM, subBuilder: $2.Artifact.create)
  ...
  /// article msg.db
  @$pb.TagNumber(1)
  $core.List<$2.Artifact> get elements => $_getList(0);
...
class GetResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'extremo.api.mypage.artifacts.v1'), createEmptyInstance: create)
    ..aOM<$2.Artifact>(1, _omitFieldNames ? '' : 'element', subBuilder: $2.Artifact.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set element($2.Artifact v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasElement() => $_has(0);
  @$pb.TagNumber(1)
  void clearElement() => clearField(1);
  @$pb.TagNumber(1)
  $2.Artifact ensureElement() => $_ensure(0);
}
...
class CreateRequest extends $pb.GeneratedMessage {
  factory CreateRequest({
    ...
    $0.Timestamp? publishFrom,
    $0.Timestamp? publishUntil,
  }) {
    final $result = create();
    if (title != null) {
      $result.title = title;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'extremo.api.mypage.artifacts.v1'), createEmptyInstance: create)
    ...
    ..aOM<$0.Timestamp>(5, _omitFieldNames ? '' : 'publishFrom', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(6, _omitFieldNames ? '' : 'publishUntil', subBuilder: $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  /// start
  @$pb.TagNumber(5)
  $0.Timestamp get publishFrom => $_getN(4);
  @$pb.TagNumber(5)
  set publishFrom($0.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasPublishFrom() => $_has(4);
  @$pb.TagNumber(5)
  void clearPublishFrom() => clearField(5);
  @$pb.TagNumber(5)
  $0.Timestamp ensurePublishFrom() => $_ensure(4);

  /// until
  @$pb.TagNumber(6)
  $0.Timestamp get publishUntil => $_getN(5);
  @$pb.TagNumber(6)
  set publishUntil($0.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasPublishUntil() => $_has(5);
  @$pb.TagNumber(6)
  void clearPublishUntil() => clearField(6);
  @$pb.TagNumber(6)
  $0.Timestamp ensurePublishUntil() => $_ensure(5);
}
...
class UpdateRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'extremo.api.mypage.artifacts.v1'), createEmptyInstance: create)
    ...
    ..aOM<$0.Timestamp>(6, _omitFieldNames ? '' : 'publishFrom', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(7, _omitFieldNames ? '' : 'publishUntil', subBuilder: $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  /// start
  @$pb.TagNumber(6)
  $0.Timestamp get publishFrom => $_getN(5);
  @$pb.TagNumber(6)
  set publishFrom($0.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasPublishFrom() => $_has(5);
  @$pb.TagNumber(6)
  void clearPublishFrom() => clearField(6);
  @$pb.TagNumber(6)
  $0.Timestamp ensurePublishFrom() => $_ensure(5);

  /// until
  @$pb.TagNumber(7)
  $0.Timestamp get publishUntil => $_getN(6);
  @$pb.TagNumber(7)
  set publishUntil($0.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasPublishUntil() => $_has(6);
  @$pb.TagNumber(7)
  void clearPublishUntil() => clearField(7);
  @$pb.TagNumber(7)
  $0.Timestamp ensurePublishUntil() => $_ensure(6);
}
...
class CreateImageRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateImageRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'extremo.api.mypage.artifacts.v1'), createEmptyInstance: create)
    ...
    ..e<$1.ArtifactImageEnum_Kind>(2, _omitFieldNames ? '' : 'kind', $pb.PbFieldType.OE, defaultOrMaker: $1.ArtifactImageEnum_Kind.KIND_UNSPECIFIED, valueOf: $1.ArtifactImageEnum_Kind.valueOf, enumValues: $1.ArtifactImageEnum_Kind.values)
  ...
  @$pb.TagNumber(2)
  $1.ArtifactImageEnum_Kind get kind => $_getN(1);
  @$pb.TagNumber(2)
  set kind($1.ArtifactImageEnum_Kind v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class CreateImageResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CreateImageResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'extremo.api.mypage.artifacts.v1'), createEmptyInstance: create)
    ..aOM<$2.ArtifactImage>(1, _omitFieldNames ? '' : 'element', subBuilder: $2.ArtifactImage.create)
    ..hasRequiredFields = false
  ;
  ...
  /// A user message. if request user is not published, it filtered them. so response might be empty.
  @$pb.TagNumber(1)
  $2.ArtifactImage get element => $_getN(0);
  @$pb.TagNumber(1)
  set element($2.ArtifactImage v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasElement() => $_has(0);
  @$pb.TagNumber(1)
  void clearElement() => clearField(1);
  @$pb.TagNumber(1)
  $2.ArtifactImage ensureElement() => $_ensure(0);
}
...
class ArtifactServiceApi {
  ...
  ArtifactServiceApi(this._client);

  $async.Future<UpdateResponse> update($pb.ClientContext? ctx, UpdateRequest request) =>
    _client.invoke<UpdateResponse>(ctx, 'ArtifactService', 'Update', request, UpdateResponse())
  ;
  $async.Future<$3.Empty> delete($pb.ClientContext? ctx, DeleteRequest request) =>
    _client.invoke<$3.Empty>(ctx, 'ArtifactService', 'Delete', request, $3.Empty())
  ;
  $async.Future<GetResponse> get($pb.ClientContext? ctx, GetRequest request) =>
    _client.invoke<GetResponse>(ctx, 'ArtifactService', 'Get', request, GetResponse())
  ;
  $async.Future<ListResponse> list($pb.ClientContext? ctx, ListRequest request) =>
    _client.invoke<ListResponse>(ctx, 'ArtifactService', 'List', request, ListResponse())
  ;
  $async.Future<CreateResponse> create_($pb.ClientContext? ctx, CreateRequest request) =>
    _client.invoke<CreateResponse>(ctx, 'ArtifactService', 'Create', request, CreateResponse())
  ;
  $async.Future<CreateImageResponse> createImage($pb.ClientContext? ctx, CreateImageRequest request) =>
    _client.invoke<CreateImageResponse>(ctx, 'ArtifactService', 'CreateImage', request, CreateImageResponse())
  ;
  $async.Future<UpdateImageResponse> updateImage($pb.ClientContext? ctx, UpdateImageRequest request) =>
    _client.invoke<UpdateImageResponse>(ctx, 'ArtifactService', 'UpdateImage', request, UpdateImageResponse())
  ;
}
