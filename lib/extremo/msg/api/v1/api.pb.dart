...
class Account extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Account', package: const $pb.PackageName(_omitMessageNames ? '' : 'extremo.msg.api.v1'), createEmptyInstance: create)
    ...
    ..aOM<$4.Timestamp>(20, _omitFieldNames ? '' : 'dateJoined', subBuilder: $4.Timestamp.create)
    ..aOB(30, _omitFieldNames ? '' : 'isDeleted')
    ..aOM<$4.Timestamp>(400, _omitFieldNames ? '' : 'deletedAt', subBuilder: $4.Timestamp.create)
  ...
  /// Sign Up date
  @$pb.TagNumber(20)
  $4.Timestamp get dateJoined => $_getN(1);
  @$pb.TagNumber(20)
  set dateJoined($4.Timestamp v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasDateJoined() => $_has(1);
  @$pb.TagNumber(20)
  void clearDateJoined() => clearField(20);
  @$pb.TagNumber(20)
  $4.Timestamp ensureDateJoined() => $_ensure(1);
  ...
  @$pb.TagNumber(400)
  set deletedAt($4.Timestamp v) { setField(400, v); }
  @$pb.TagNumber(400)
