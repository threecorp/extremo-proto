...
class Account extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Account', package: const $pb.PackageName(_omitMessageNames ? '' : 'extremo.msg.api.v1'), createEmptyInstance: create)
    ...
    ..aOM<$10.Timestamp>(3, _omitFieldNames ? '' : 'dateJoined', subBuilder: $10.Timestamp.create)
    ..aOB(4, _omitFieldNames ? '' : 'isDeleted')
    ..aOM<$10.Timestamp>(5, _omitFieldNames ? '' : 'deletedAt', subBuilder: $10.Timestamp.create)
  ...
  /// Sign Up date
  @$pb.TagNumber(3)
  $10.Timestamp get dateJoined => $_getN(2);
  @$pb.TagNumber(3)
  set dateJoined($10.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasDateJoined() => $_has(2);
  @$pb.TagNumber(3)
  void clearDateJoined() => clearField(3);
  @$pb.TagNumber(3)
  $10.Timestamp ensureDateJoined() => $_ensure(2);
  ...
  /// Deleted time
  @$pb.TagNumber(5)
  $10.Timestamp get deletedAt => $_getN(4);
  @$pb.TagNumber(5)
  set deletedAt($10.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDeletedAt() => $_has(4);
  @$pb.TagNumber(5)
  void clearDeletedAt() => clearField(5);
  @$pb.TagNumber(5)
  $10.Timestamp ensureDeletedAt() => $_ensure(4);
}
