...
import '../../../../msg/api/v1/api.pb.dart' as $10;
...
class RegisterResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RegisterResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'extremo.api.auth.accounts.v1'), createEmptyInstance: create)
    ..aOM<$10.AccountToken>(1, _omitFieldNames ? '' : 'element', subBuilder: $10.AccountToken.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $10.AccountToken get element => $_getN(0);
  @$pb.TagNumber(1)
  set element($10.AccountToken v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasElement() => $_has(0);
  @$pb.TagNumber(1)
  void clearElement() => clearField(1);
  @$pb.TagNumber(1)
  $10.AccountToken ensureElement() => $_ensure(0);
}
...
class GetAccountByTokenResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetAccountByTokenResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'extremo.api.auth.accounts.v1'), createEmptyInstance: create)
    ..aOM<$10.Account>(1, _omitFieldNames ? '' : 'element', subBuilder: $10.Account.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $10.Account get element => $_getN(0);
  @$pb.TagNumber(1)
  set element($10.Account v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasElement() => $_has(0);
  @$pb.TagNumber(1)
  void clearElement() => clearField(1);
  @$pb.TagNumber(1)
  $10.Account ensureElement() => $_ensure(0);
}
