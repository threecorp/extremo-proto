...
class DurationRules extends $pb.GeneratedMessage {
  ...
  /// Const specifies that this field must be exactly the specified value
  @$pb.TagNumber(2)
  $3.Duration get const_2 => $_getN(1);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(2)
  $3.Duration ensureConst_2() => $_ensure(1);

  /// Lt specifies that this field must be less than the specified value,
  /// exclusive
  @$pb.TagNumber(3)
  $3.Duration get lt => $_getN(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(3)
  $3.Duration ensureLt() => $_ensure(2);

  /// Lt specifies that this field must be less than the specified value,
  /// inclusive
  @$pb.TagNumber(4)
  $3.Duration get lte => $_getN(3);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(4)
  $3.Duration ensureLte() => $_ensure(3);

  /// Gt specifies that this field must be greater than the specified value,
  /// exclusive
  @$pb.TagNumber(5)
  $3.Duration get gt => $_getN(4);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(5)
  $3.Duration ensureGt() => $_ensure(4);

  /// Gte specifies that this field must be greater than the specified value,
  /// inclusive
  @$pb.TagNumber(6)
  $3.Duration get gte => $_getN(5);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(6)
  $3.Duration ensureGte() => $_ensure(5);

  /// In specifies that this field must be equal to one of the specified
  /// values
  @$pb.TagNumber(7)
  $core.List<$3.Duration> get in_7 => $_getList(6);

  /// NotIn specifies that this field cannot be equal to one of the specified
  /// values
  @$pb.TagNumber(8)
  $core.List<$3.Duration> get notIn => $_getList(7);
}
...
class TimestampRules extends $pb.GeneratedMessage {
  ...
  /// Const specifies that this field must be exactly the specified value
  @$pb.TagNumber(2)
  $4.Timestamp get const_2 => $_getN(1);
  @$pb.TagNumber(2)
  ...
  void clearConst_2() => clearField(2);
  @$pb.TagNumber(2)
  $4.Timestamp ensureConst_2() => $_ensure(1);

  /// Lt specifies that this field must be less than the specified value,
  /// exclusive
  @$pb.TagNumber(3)
  $4.Timestamp get lt => $_getN(2);
  @$pb.TagNumber(3)
  ...
  void clearLt() => clearField(3);
  @$pb.TagNumber(3)
  $4.Timestamp ensureLt() => $_ensure(2);

  /// Lte specifies that this field must be less than the specified value,
  /// inclusive
  @$pb.TagNumber(4)
  $4.Timestamp get lte => $_getN(3);
  @$pb.TagNumber(4)
  ...
  void clearLte() => clearField(4);
  @$pb.TagNumber(4)
  $4.Timestamp ensureLte() => $_ensure(3);

  /// Gt specifies that this field must be greater than the specified value,
  /// exclusive
  @$pb.TagNumber(5)
  $4.Timestamp get gt => $_getN(4);
  @$pb.TagNumber(5)
  ...
  void clearGt() => clearField(5);
  @$pb.TagNumber(5)
  $4.Timestamp ensureGt() => $_ensure(4);

  /// Gte specifies that this field must be greater than the specified value,
  /// inclusive
  @$pb.TagNumber(6)
  $4.Timestamp get gte => $_getN(5);
  @$pb.TagNumber(6)
  ...
  void clearGte() => clearField(6);
  @$pb.TagNumber(6)
  $4.Timestamp ensureGte() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $3.Duration ensureWithin() => $_ensure(8);
}
