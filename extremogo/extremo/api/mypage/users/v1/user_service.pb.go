...
var file_extremo_api_mypage_users_v1_user_service_proto_rawDesc = string([]byte{
...
var (
	...
	file_extremo_api_mypage_users_v1_user_service_proto_rawDescData []byte
)
...
func file_extremo_api_mypage_users_v1_user_service_proto_rawDescGZIP() []byte {
	file_extremo_api_mypage_users_v1_user_service_proto_rawDescOnce.Do(func() {
		file_extremo_api_mypage_users_v1_user_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_extremo_api_mypage_users_v1_user_service_proto_rawDesc), len(file_extremo_api_mypage_users_v1_user_service_proto_rawDesc)))
	})
...
func file_extremo_api_mypage_users_v1_user_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_extremo_api_mypage_users_v1_user_service_proto_rawDesc), len(file_extremo_api_mypage_users_v1_user_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
