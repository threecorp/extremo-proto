...
var file_extremo_msg_db_v1_enum_proto_rawDesc = string([]byte{
...
var (
	...
	file_extremo_msg_db_v1_enum_proto_rawDescData []byte
)

func file_extremo_msg_db_v1_enum_proto_rawDescGZIP() []byte {
	file_extremo_msg_db_v1_enum_proto_rawDescOnce.Do(func() {
		file_extremo_msg_db_v1_enum_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_extremo_msg_db_v1_enum_proto_rawDesc), len(file_extremo_msg_db_v1_enum_proto_rawDesc)))
	})
...
func file_extremo_msg_db_v1_enum_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_extremo_msg_db_v1_enum_proto_rawDesc), len(file_extremo_msg_db_v1_enum_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
